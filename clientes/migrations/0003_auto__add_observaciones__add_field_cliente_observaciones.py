...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'clientes_observaciones', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('descripcion', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'clientes', ['Observaciones'])

        # Adding field 'Cliente.observaciones'
        db.add_column(u'clientes_cliente', 'observaciones',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clientes.Observaciones'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Observaciones'
        db.delete_table(u'clientes_observaciones')

        # Deleting field 'Cliente.observaciones'
        db.delete_column(u'clientes_cliente', 'observaciones_id')
