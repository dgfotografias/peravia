...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respuesta.cliente'
        db.add_column(u'polls_respuesta', 'cliente',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clientes.Cliente'], null=True),
                      keep_default=False)

        # Adding field 'Respuesta.creada'
        db.add_column(u'polls_respuesta', 'creada',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 19, 0, 0), auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respuesta.cliente'
        db.delete_column(u'polls_respuesta', 'cliente_id')

        # Deleting field 'Respuesta.creada'
        db.delete_column(u'polls_respuesta', 'creada')
